...
export const MiningTruckIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M10 17h4v-4h-4v4ZM2 11h1.5a2.5 2.5 0 0 1 0 5H2v-5Zm18.5 0H22v5h-1.5a2.5 2.5 0 0 1 0-5ZM4 11V9c0-1.1.9-2 2-2h12a2 2 0 0 1 2 2v2H4Zm0 5h16v-2a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v2Z"/>
    </svg>
);
...
export const HourglassIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M5 22h14M5 2h14M12 12v0M19 2l-7 8-7-8M5 22l7-8 7 8"/>
    </svg>
);

// FIX: Add missing GearIcon to resolve import error in CycleTime.tsx
...
export const LightbulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 18h6M10 22h4M12 2a7 7 0 0 0-7 7c0 3 2 5 2 7h10c0-2 2-4 2-7a7 7 0 0 0-7-7Z"/>
    </svg>
);
